    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_character_titles", x => new { x.CharacterId, x.TileId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_character_titles_titles_TileId",
                        column: x => x.TileId,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 40, "Adam", "Nowak", 100 },
                    { 2, 55, "Aleksandra", "Wiśniewska", 120 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CharacterId", "TileId", "AquiredAt" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, 2, new DateTime(2024, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 1, new DateTime(2014, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_character_titles_TileId",
                table: "character_titles",
                column: "TileId");
        }
